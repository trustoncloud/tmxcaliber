...
from tmxcaliber.lib.change_log import Change, ChangeLog, generate_change_log, manual_diff, get_changes_from_deepdiff

@pytest.fixture
def sample_data():
    old_json = {
        "metadata": {
            "release": "1625155200"  # Example epoch time
        },
        "controls": {
    ...
    new_json = {
        "metadata": {
            "release": "1627750800"  # Example epoch time
        },
        "controls": {
            "Service.C2": {"description": "Old control 2", "weighted_priority": "High"},
...
def test_add_sub_change():
    parent_change = Change(change_type="modified", category="controls", identifier="Service.C1")
    sub_change = Change(change_type="added", category="controls", identifier="Service.C2")
...
def test_changelog_get_sorted_changes():
    ...
    change2 = Change(change_type="removed", category="controls", identifier="Service.C2")
