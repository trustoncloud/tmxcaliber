...
def test_json_modification():
    ...
    filter_json = {
        'controls': {'someservice.C1': {
            "feature_class": ["someservice.FC1", "someservice.FC2"],  # added new feature class
            "objective": 'someservice.CO1',
        ...
        'control_objectives': {'someservice.CO1': {'scf': ['SCF2']}}  # changed scf value
    }
